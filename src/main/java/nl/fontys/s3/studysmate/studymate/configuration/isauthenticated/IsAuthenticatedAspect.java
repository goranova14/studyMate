package nl.fontys.s3.studysmate.studymate.configuration.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(nl.fontys.s3.studysmate.studymate.configuration.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(nl.fontys.s3.studysmate.studymate.configuration.isauthenticated.IsAuthenticated)")
